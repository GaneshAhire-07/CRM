...
const NavBar = ({ toggleSidebar, onProfileClick }) => {
  ...
  return (
    <>
            ...
            {isBookmarkOpen && (
              <div className="bookmark-dropdown">
                ...
                <ul className="bookmark-list">
                  <li>
                    <Link
                      to="/starred-projects?tab=projects"
                  ...
                  <li>
                    <Link
                      to="/starred-projects?tab=clients"
                      onClick={() => setIsBookmarkOpen(false)}
                    >
                  ...
                  <li>
                    <Link
                      to="/starred-projects?tab=comments"
                      onClick={() => setIsBookmarkOpen(false)}
                    >
                  ...
                  <div className="notification-item">
                    ...
                    <div className="notification-details">
                      ...
                      <div className="notification-message">
                        Peter, Can we schedule a Zoom meeting next week to
                        discuss this lead?
                      </div>
                    </div>
                  </div>
      ...
      {/* Conditionally render AddTaskForm */}
      {isAddTaskFormOpen && (
        <AddTaskForm
      ...
      {/* Conditionally render AddLeadForm */}
      {isAddLeadFormOpen && (
        <AddLeadForm
